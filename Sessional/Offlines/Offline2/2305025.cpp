...
public:
    ...
    //         courses[i] = other.courses[i];
    //     }
    //     this->gradePoint = new float[totalCourses];
    //     for (int i = 0; i < totalCourses; ++i)
    //     {
    //         gradePoint[i] = other.gradePoint[i];
    //     }
    ...
    //     Course *newCourses = new Course[other.maxCourses];
    //     float *newGradePoint = new float[other.maxCourses];

  
    //     for (int i = 0; i < other.totalCourses; ++i)
    //     {
    //         newCourses[i] = other.courses[i];
    //         newGradePoint[i] = other.gradePoint[i];
    //     }
    ...
    void addCourse(Course course, float gradePoint)
    {
        ...
        {
            cout << "Cannot add more courses to " << endl; //<< this->getName();
            return;
        }
    }
