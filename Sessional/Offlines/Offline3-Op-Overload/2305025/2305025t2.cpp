...
int main()
{
    ...
    mat3[0][0] = Fraction(1, 2);
    mat3[0][1] = Fraction(3, 4);
    mat3[0][2] = Fraction(1, 1);
    mat3[1][0] = Fraction(2, 3);
    mat3[1][1] = Fraction(4, 5);
    mat3[1][2] = Fraction(1, 2);
    ...
    // Additional edge case: Empty matrix
